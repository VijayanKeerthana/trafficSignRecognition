# -*- coding: utf-8 -*-
"""
Created on Sun Jan 30 14:06:19 2022
...
set_tflite = 1
if set_tflite==1:
    interpreter = tf.lite.Interpreter(model_path=r"D:\Model\compressed_model\Compressed_only.tflite")
...
if __name__ == '__main__':
    ...
    video_path = r"D:\Model\video_input\1.mp4"
    output_path = r"D:\Model\video_output\Compressed_only"
  #  model_name = "../Train_Model2/trafficsignnet.model/20220116-202944"  # grayscale clahe
    model_name = r"D:\Model\compressed_model\Compressed_only.tflite" 
    ...
    #yolo setup
    net = cv2.dnn.readNet (r"D:\Model\yolov4-tiny_training_last.weights", r"D:\Model\yolov4-tiny_training.cfg")
    layer_names = net.getLayerNames()
    output_layers = [layer_names[i - 1] for i in net.getUnconnectedOutLayers()]
    confidence_threshold = 0.5
    
    # load the label names
    labelNames = open(r"D:\Model\signnames.csv").read().strip().split("\n")[1:]
