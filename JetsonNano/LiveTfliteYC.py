...
set_tflite = 1
if set_tflite==1:
    interpreter = tf.lite.Interpreter(model_path="Compressed_only.tflite")
...
def predict_label(model, roi, labelNames):
    ...
    if set_tflite==1:
       # print('tflite predictions')
        ...
        #print('tflite predictions', preds)
        label = labelNames[preds]
        #print('laaaaaaaaaaaaabel', label)
...
if __name__ == '__main__':
  ...
  # 
    ...
    if set_tflite ==0:
        model_name = "trafficsignnet.model/20220117-180435.hdf"  # grayscale clahe
